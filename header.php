    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#" aria-label="Bits & Bytes Association">
            <img class="logo" src="./assets/img/logos/bba_logo.png" alt="Bits & Bytes Association">
        </a>
